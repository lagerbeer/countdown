...
$(function () {
	...
	if (!announced && new Date() < new Date(2015, 10-1, 19)) {
		$('<div title="Special Offer">My book, ' +
			'<a href="https://www.manning.com/books/extending-jquery" target="_blank">Extending jQuery</a>, ' +
			'is Manning\'s Deal of the Day on October 18. Use code <strong>dotd101815au</strong> ' +
